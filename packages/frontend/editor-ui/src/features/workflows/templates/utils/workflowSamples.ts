...
import competitorPriceMonitoringJson from './samples/competitor_price_monitoring.json';
...
export const getCompetitorPriceMonitoringWorkflowJson = (): WorkflowDataWithTemplateId => {
    return getWorkflowJson(competitorPriceMonitoringJson);
};

export const SampleTemplates = {
    RagStarterTemplate: getRagStarterWorkflowJson().meta.templateId,
    EasyAiTemplate: getEasyAiWorkflowJson().meta.templateId,
    CompetitorPriceMonitoring: getCompetitorPriceMonitoringWorkflowJson().meta.templateId,
} as const;
...
export const getSampleWorkflowByTemplateId = (
    ...
    const workflows = [
        ...
        getCompetitorPriceMonitoringWorkflowJson(),
