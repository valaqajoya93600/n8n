...
describe('flattenJSON', () => {
    it('should flatten nested objects and arrays using dot notation', () => {
        const input = {
            a: 1,
            b: {
                c: 2,
    ...
    it('should handle primitive values inside arrays', () => {
        const input = {
            list: [1, true, 'text'],
        };
    ...
    it('should preserve null and undefined values', () => {
        ...
        expect(flattenJSON(input)).toEqual({
            nullValue: null,
            undefinedValue: undefined,
            'deep.nestedNull': null,
            'deep.nestedUndefined': undefined,
        });
    });
    ...
    it('should return an empty object when input is a primitive or null at root', () => {
        expect(flattenJSON(null)).toEqual({});
        expect(flattenJSON(undefined)).toEqual({});
        expect(flattenJSON('text')).toEqual({});
        expect(flattenJSON(42)).toEqual({});
    });
});
